...
if __name__ == "__main__":
    img_root = 'outputs/grpose/grpose_HumanArt-8-L40S/images'# please specify path to generated images
    ...
    for sub_folder in os.listdir('val_jsons'):
        ...
        quality_metrics = QualityMetrics(device='cuda',
                         refer_dataset_base_dir='../Human-Art', # please specify path to HumanArt here
